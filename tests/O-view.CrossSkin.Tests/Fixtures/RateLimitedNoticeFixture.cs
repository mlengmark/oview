...
/// (OVI-80, Phase 1 slice 3.2). Kept as its own type, parallel to <see cref="GoldenMasterFixture"/>,
/// <see cref="FreshnessFixture"/>, and <see cref="PanelTextResetFixture"/> rather than a change
...
/// at all and does not share PanelTextResetFixture's multi-member <c>Render</c>-closure shape
/// either — it is the only member this family covers. Reuses <see cref="ContentFact"/> as-is.
/// </summary>
